...
export const SET_CURRENT_PLAYLIST_INFOS = 'SET_CURRENT_PLAYLIST_INFOS';
export const SET_CURRENT_USER_INFOS = 'SET_CURRENT_USER_INFOS';
...
export const setCurrentPlaylistInfos = (newValue) => ({
  type: SET_CURRENT_PLAYLIST_INFOS,
  value: newValue,
});

export const setCurrentUserInfos = (newValue) => ({
  type: SET_CURRENT_USER_INFOS,
  value: newValue,
});
